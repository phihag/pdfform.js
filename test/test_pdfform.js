...
describe("pdfform", function () {
  it("example conversion", function (done) {
    ...
    var fields = {
      NumerischesFeld1: [1, 2, 3, 4, 5, 6],
      NumerischesFeld2: [
        5, 6, 7, 8, 9, 10, 1, 2, 5, 6, 7, 8, 9, 10, 1, 2, 5, 6, 7, 8, 9, 10, 1,
        2, 5, 6, 7, 8, 9, 10, 1, 2, 5, 6, 7, 8, 9, 10, 1, 2, 5, 6, 7, 8, 9, 10,
        1, 2, 5, 6, 7, 8, 9, 10, 1, 2,
      ],
      Textfeld1: ["EIns"],
      Textfeld2: ["zwei"],
      Textfeld3: ["drei"],
      ...
      Textfeld9: [
        ...
        "content",
        "all",
        "around the the world with really long",
      ],
      Textfeld10: [
        "zehn-1",
        "zehn2",
  ...
  it("serialize_str", () => {
    ...
    assert.strictEqual(
      serialize_str("a ≤ b ä"),
      "(\xfe\xff\x00a\x00 \"d\x00 \x00b\x00 \x00\xe4)"
    );
  });
